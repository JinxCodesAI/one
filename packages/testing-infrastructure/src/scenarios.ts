...
export function createSuccessScenario(
  providers: Array<"openai" | "google" | "openrouter" | "anthropic"> = [
    "openai",
    "google",
    "openrouter",
    "anthropic",
  ...
  return {
    ...
    isRequestExpected: (
      ...
      return metadata.isExternalApi &&
        ...
        providers.includes(
          metadata.provider as "openai" | "google" | "openrouter" | "anthropic",
        );
    },
...
export function createMixedScenario(config: {
  ...
  return {
    ...
    isRequestExpected: (
      ...
      return metadata.isExternalApi &&
        metadata.provider !== "unknown" &&
        ["openai", "google", "openrouter", "anthropic"].includes(
          metadata.provider,
        ) &&
