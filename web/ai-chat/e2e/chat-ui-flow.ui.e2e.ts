...
const OPENAI_RESPONSE =
  "Hello! This is GPT-4.1-nano responding to your message through the UI.";
const GOOGLE_RESPONSE =
  "Hello! This is Gemini-2.5-flash responding to your message through the UI.";
const ANTHROPIC_RESPONSE =
  "Hello! This is Claude-3.5-sonnet responding to your message through the UI.";
...
describe("UI E2E: Complete Chat Application Flow", () => {
  ...
  it("should complete full chat flow: select model -> type message -> send -> receive response", async () => {
    ...
    const selectedModel = await page.locator('[data-testid="model-selector"]')
      .inputValue();
    ...
    const inputValue = await page.locator('[data-testid="message-input"]')
      .inputValue();
    ...
    const clearedInput = await page.locator('[data-testid="message-input"]')
      .inputValue();
  ...
  it("should show loading states during message sending", async () => {
    ...
    const buttonText = await page.locator('[data-testid="send-button"]')
      .textContent();
