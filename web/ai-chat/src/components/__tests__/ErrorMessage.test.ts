...
describe("ErrorMessage Component Logic", () => {
  ...
  it("should handle long error messages", () => {
    const longError = "This is a very long error message that should wrap properly and maintain readability even when it contains multiple sentences and detailed information about what went wrong.";
